    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>An e-commerce website is an online store where customers can buy and sell products and services over the internet. It is the virtual equivalent of a physical store, with product listings, categories, reviews, and a cash register.</p>
